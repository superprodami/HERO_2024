...
//            this_time_rx_len = CMNT_RX_MAX - hdma_usart1_rx.Instance->NDTR;
//            //重新设定数据长度
//            hdma_usart1_rx.Instance->NDTR = CMNT_RX_MAX;
//            //设定缓冲区1
//            hdma_usart1_rx.Instance->CR |= DMA_SxCR_CT;
//            //使能DMA
//            __HAL_DMA_ENABLE(&hdma_usart1_rx);
//            if(this_time_rx_len == CMNT_LONG)
//            {
//               CMNT_receive_UART(board_rx_buf[1]);
//            }
//        }
//        else
//        {
...
//            if(this_time_rx_len == CMNT_LONG)
//            {
//               CMNT_receive_UART(board_rx_buf[0]);
//            }
//        }
//    }	
