...
extern fp32 IMU_angle[3],INS_angle[3];
extern volatile bool_t imu_init_finish_flag;
extern volatile bool_t gimbal_return_finish_flag;
/**
...
//				{
//					Chass_Move_MSG.IMU_Chass_MSG.ol_angle[i] = INS_angle[i];
//				}
//				for(uint8_t i = 0; i < 4; i++)
//				{
//					Chass_Move_MSG.IMU_Chass_MSG.quat_[i] = INS_quat[i];
//				}				
//				for(uint8_t i = 0; i < 3; i++)
//				{
//					Chass_Move_MSG.IMU_Chass_MSG.omg_rad[i] = INS_gyro[i];
//				}					
//				Chass_Move_MSG.IMU_Chass_MSG.temp = bmi088_real_data.temp;
//        /*------------------*/
